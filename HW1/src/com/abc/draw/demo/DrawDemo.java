 ...
 * Program: This program is written and provided by my instructor
 */
...
public class DrawDemo {
	private static Drawing createDrawing() {
		...
		Triangle t1 = new Triangle(new Point(10.0, 20.0),
				new Point(10.0, 300.0), new Point(50.0, 50.0));
		drawing.append(t1);

		Triangle t2 = new Triangle(new Point(100.0, 100.0), new Point(380.0,
				170.0), new Point(150.0, 300.0));
		drawing.append(t2);
